...
출처 : https://github.com/spring-cloud/spring-cloud-dataflow/tree/main/src/docker-compose

```bash
# 받기
curl -O https://github.com/spring-cloud/spring-cloud-dataflow/blob/main/src/docker-compose/dc.sh
```
```bash
