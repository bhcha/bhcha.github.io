...
<img src="../devops/images/img_17.png"/>
...
a. Host 연결
   - host에 연결하기위해선 network 설정이 필요하다. 두가지 방법 중 하나 택1
     · vi /etc/hosts에서 host 추가
       <img src="../devops/images/img_18.png"/>
...
b. ssh 연결 테스트(Docker)
   ...
   - $ ssh root/root1234@host.docker.internal
     <img src="../devops/images/img_19.png"/>
...
c. ssh 비밀번호 없이 연결
   ...
   - 공개키 등록(Host)
     ...
     <img src="../devops/images/img_20.png"/>

d. 다시 접속 테스트
   <img src="../devops/images/img_21.png"/>
   ...
   <img src="../devops/images/img_22.png"/>
   host에서는 잘되는데 말이다.
   <img src="../devops/images/img_23.png"/>
   그래서 절대경로로 실행해 보았다.
   <img src="../devops/images/img_24.png"/>
...
결국 타협하여 Gitlab Container에 sqplus를 설치했다.
   ...
   e. 환경변수 등록
      ...
      $ source ~/.bashrc
   f. sqlplus 실행(실패)
      <img src="../devops/images/img_25.png"/>
   g. 당황하지 말고 libaio 설치
      $ apt-get install libaio1 libaio-dev
   h. sqlplus 실행(성공)
      <img src="../devops/images/img_26.png"/>
</pre>
...
<pre>
   ...
   * 특수문자가 있다면 반드시 \를 넣어줘야 한다.(password포함)
   ...
   <img src="../devops/images/img_28.png"/>
